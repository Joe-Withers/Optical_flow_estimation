...
class UnSupFlowNet():
    ...
    load_model_path = 'ignore', save_model_path = 'ignore', save_flow_im_path = 'ignore', save_step = 100, show_step=-1):
        ...
        w_err1, p_im1 = warping_error(x[:,:,:,1], x[:,:,:,0], flow1, -1)
        w_err2, p_im2 = warping_error(x[:,:,:,1], x[:,:,:,0], flow2, -1)
        w_err3, p_im3 = warping_error(x[:,:,:,1], x[:,:,:,0], flow3, -1)
        w_err4, p_im4 = warping_error(x[:,:,:,1], x[:,:,:,0], flow4, -1)
        w_err5, p_im5 = warping_error(x[:,:,:,1], x[:,:,:,0], flow5, -1)
        w_err6, p_im6 = warping_error(x[:,:,:,1], x[:,:,:,0], flow6, -1)
