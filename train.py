...
#load data
# im1_filenames,im2_filenames,y_filenames = ds.load_my_synthetic_image_filenames(im_path, n_data=100)
im1_filenames,im2_filenames,y_filenames = ds.load_synthetic_chairs_image_filenames(im_path, n_data=22231)
